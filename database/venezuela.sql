...
CREATE TABLE IF NOT EXISTS `basest01s` (
...
INSERT INTO `basest01s` (`id_estado`, `estado`, `iso_3166-2`) VALUES
(1, 'Amazonas', 'VE-X'),
(2, 'Anzoátegui', 'VE-B'),
(3, 'Apure', 'VE-C'),
(4, 'Aragua', 'VE-D'),
...
CREATE TABLE IF NOT EXISTS `basciu01s` (
...
INSERT INTO `basciu01s` (`id_ciudad`, `id_estado`, `ciudad`, `capital`) VALUES
(1, 1, 'Maroa', 0),
...
CREATE TABLE IF NOT EXISTS `basmun01s` (
...
INSERT INTO `basmun01s` (`id_municipio`, `id_estado`, `municipio`) VALUES
(1, 1, 'Alto Orinoco'),
(2, 1, 'Atabapo'),
(3, 1, 'Atures'),
(4, 1, 'Autana'),
...
CREATE TABLE IF NOT EXISTS `baspar01s` (
...
INSERT INTO `baspar01s` (`id_parroquia`, `id_municipio`, `parroquia`) VALUES
(1, 1, 'Alto Orinoco'),
...
CREATE TABLE IF NOT EXISTS `basurb01s` (
  `id_urbanismo` int(11) NOT NULL AUTO_INCREMENT,
  `urbanismo` varchar(250) NOT NULL,
  `id_parroquia` int(11) NOT NULL,
  PRIMARY KEY (`id_urbanismo`),
  KEY `id_parroquia` (`id_parroquia`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;

ALTER TABLE `basciu01s`
  ADD CONSTRAINT `ciudades_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `basest01s` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `basmun01s`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`id_estado`) REFERENCES `basest01s` (`id_estado`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `baspar01s`
  ADD CONSTRAINT `parroquias_ibfk_1` FOREIGN KEY (`id_municipio`) REFERENCES `basmun01s` (`id_municipio`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `basurb01s`
  ADD CONSTRAINT `urbanismos_ibfk_1` FOREIGN KEY (`id_parroquia`) REFERENCES `baspar01s` (`id_parroquia`) ON DELETE CASCADE ON UPDATE CASCADE;
